...
export interface POAPInterface extends utils.Interface {
  functions: {
    ...
    "getIdeaIdByTokenId(uint256)": FunctionFragment;
    "ideaIdOfTokenId(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getIdeaIdByTokenId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "ideaIdOfTokenId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
