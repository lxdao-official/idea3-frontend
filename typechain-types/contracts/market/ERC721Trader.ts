...
export declare namespace ERC721Trader {
...
export interface ERC721TraderInterface extends utils.Interface {
  functions: {
...
export interface ERC721Trader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TraderInterface;
  ...
  functions: {
    ...
    orderOfTokenId(
      tokenId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ERC721Trader.TraderOrderStructOutput]>;
