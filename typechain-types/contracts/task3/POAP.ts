...
export interface POAPInterface extends utils.Interface {
  functions: {
    ...
    "getOrderIdByTokenId(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "mint(address,uint256)": FunctionFragment;
    "name()": FunctionFragment;
    "orderIdOfTokenId(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOrderIdByTokenId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "orderIdOfTokenId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
