...
export interface DAOTaskOrderNFTInterface extends utils.Interface {
  functions: {
...
export interface DAOTaskOrderNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DAOTaskOrderNFTInterface;
