...
export declare namespace Comment {
  ...
  export type CommentStructStructOutput = [
    BigNumber,
    BigNumber,
    string,
    string,
...
export interface CommentInterface extends utils.Interface {
  ...
  events: {
    ...
    "CommentSubmitted(uint256,uint256,string,address)": EventFragment;
...
export interface CommentSubmittedEventObject {
  id: BigNumber;
  topicId: BigNumber;
  markdown: string;
  submitter: string;
}
export type CommentSubmittedEvent = TypedEvent<
  [BigNumber, BigNumber, string, string],
  CommentSubmittedEventObject
>;

export type CommentSubmittedEventFilter =
  TypedEventFilter<CommentSubmittedEvent>;
...
export interface Comment extends BaseContract {
  ...
  functions: {
    ...
    commentCount(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    getComment(
      ...
      commentId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[Comment.CommentStructStructOutput]>;
  ...
  filters: {
    ...
    "CommentSubmitted(uint256,uint256,string,address)"(
      id?: null,
      topicId?: null,
      markdown?: null,
      submitter?: null
    ): CommentSubmittedEventFilter;
    CommentSubmitted(
      id?: null,
      topicId?: null,
      markdown?: null,
  ...
  populateTransaction: {
    ...
    commentCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
