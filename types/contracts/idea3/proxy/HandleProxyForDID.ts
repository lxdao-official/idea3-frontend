...
export interface HandleProxyForDIDInterface extends utils.Interface {
  functions: {
    ...
    "setDIDAddress(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setDIDAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface HandleProxyForDID extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HandleProxyForDIDInterface;
